...
import edu.wm.cs.cs301.cwshort.generation.BSPBranch;
import edu.wm.cs.cs301.cwshort.generation.BSPLeaf;
import edu.wm.cs.cs301.cwshort.generation.BSPNode;
import edu.wm.cs.cs301.cwshort.generation.Cells;
import edu.wm.cs.cs301.cwshort.generation.Seg;

//import edu.wm.cs.cs301.cwshort.falstad.MazePanel.PanelColors;
...
public class FirstPersonDrawer extends DefaultViewer {
    ...
    public void redraw(MazePanel panel, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang) {
       ...
       // panel.setColor(Color.BLACK);
        ...
        panel.setColor(Color.BLACK);
        panel.fillRect(0, 0, 400, 400);
        panel.setColor(Color.DKGRAY);
        panel.fillRect(0, 200, 400, 200);
    ...
    private void drawSegment(Seg seg) {
        ...
        int x1i = x1;
        int xd = x2-x1;
        panel.setColor(seg.getRed(), seg.getGreen(), seg.getBlue());
        boolean drawn = false;
