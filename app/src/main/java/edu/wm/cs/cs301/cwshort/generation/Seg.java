...
import edu.wm.cs.cs301.cwshort.falstad.MazeFileWriter;
...
public class Seg {
    ...
    public void storeSeg(final Document doc, final Element mazeXML,
        ...
        MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number + "_" + i,
                MazePanel.getRGB(getRed(), getGreen(), getBlue()));
    }
    ...
    public boolean equals(final Object other) {
        ...
        if ((dist != o.dist) || (partition != o.partition) || (seen != o.seen)
                || (MazePanel.getRGB(getRed(), getGreen(), getBlue()) != MazePanel.getRGB(o.getRed(), o.getGreen(), o.getBlue()))) {
            return false;
        }
